...
class Config(object):
	API_ID = int(os.environ.get("API_ID", 27604683))
	API_HASH = os.environ.get("API_HASH", "ed52a1d0803b2ed84c5cca7f20535aac")
	BOT_TOKEN = os.environ.get("BOT_TOKEN","")
	BOT_USERNAME = os.environ.get("BOT_USERNAME" , "Local_Moviesbot")
	DB_CHANNEL = int(os.environ.get("DB_CHANNEL", -1001942937148))
	BOT_OWNER = int(os.environ.get("BOT_OWNER", "1264280791"))
	DATABASE_URL = os.environ.get("DATABASE_URL","mongodb+srv://jonnywakker37:skqfQh1bIpA5LlHU@jonny37.g35vo1j.mongodb.net/?retryWrites=true&w=majority")
	UPDATES_CHANNEL = os.environ.get("UPDATES_CHANNEL", "-1001831211376")
	LOG_CHANNEL = os.environ.get("LOG_CHANNEL", "-1001910675865")
